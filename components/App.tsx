            ...
            <div className="flex-1 p-6 lg:p-12 animate-fadeIn max-w-3xl w-full">
                ...
                <div className="space-y-12">
                    {PROJECTS.map(project => (
                        <div key={project.id} className="group cursor-pointer block" onClick={() => handleProjectClick(project)}>
                            <div className="flex flex-col gap-2">
                                <div className="flex items-center justify-between mb-1">
                                    <span className="text-[10px] font-mono uppercase tracking-widest text-slate-400">{project.context || 'Personal'}</span>
                                    <ArrowRight size={14} className="text-slate-300 opacity-0 group-hover:opacity-100 transition-opacity" />
                                </div>
                                <h3 className="text-2xl font-serif text-slate-900 mb-2 group-hover:text-blue-700 transition-colors">{project.title}</h3>
                                <p className="text-sm text-slate-600 leading-relaxed mb-4 max-w-2xl">{project.description}</p>
      ...
      <div className="flex-1 p-6 lg:p-12 animate-fadeIn flex flex-col gap-16 max-w-3xl w-full">
         ...
         <section>
            ...
            <div className="mt-8 pt-8 border-t border-slate-100">
               <h3 className="text-sm font-bold text-slate-900 mb-2">Research Interests</h3>
